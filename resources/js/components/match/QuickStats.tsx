...
export default function QuickStats({ totalKills, totalRounds, matchDuration, formatTime }: Readonly<QuickStatsProps>) {
    return (
        <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
            ...
            <Card className="border border-gray-700 bg-slate-900/80">
                <CardContent className="p-4 text-center">
                    <Swords className="text-primary mx-auto mb-2 h-8 w-8" />
            ...
            <Card className="border border-gray-700 bg-slate-900/80">
                <CardContent className="p-4 text-center">
                    <Crosshair className="text-primary mx-auto mb-2 h-8 w-8" />
